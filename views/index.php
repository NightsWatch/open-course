...
<div class="row-fluid purchase margin-bottom-30">
    <div class="container">
        ...
        <a href="https://wrapbootstrap.com/theme/unify-responsive-website-template-WB0412697" class="btnu-buy hover-effect">Purchase Now</a>
    </div>
</div><!--/row-fluid-->
<!-- End Purchase Block -->
        ...
        <li class="span3">
            <div class="thumbnail-style thumbnail-kenburn">
            	<div class="thumbnail-img">
                    ...
                    <a class="btnu-more hover-effect" href="#">read more +</a>					
                </div>
